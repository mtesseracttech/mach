...
namespace mach {
	...
	public:
		...
		/*
		 * Returns true for a given key approximately for 1 frame (60 fps taken as a base line)
		 */
		static bool enter(KeyCode p_key);

		/*
		 * Returns true as long as the given key is pressed
		 */
	...
	protected:
		...
		static void key_down(int p_key);

		static void key_up(int p_key);
